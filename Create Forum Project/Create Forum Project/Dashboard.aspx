    ...
    <div id="div_table">
     <table>
      <tr>
       <td>Title : </td>
       <td>
           <asp:TextBox ID="txtposttitle" CssClass="txt" runat="server" style="width:500px;padding-right: 0px;"></asp:TextBox></td>
      </tr>
      <tr>
          <td>Content : </td>
       <td colspan="2">
           <textarea id="txtpostmessage" cols="68" rows="15" runat="server" style="width:500px;padding-right: 0px;"></textarea>
       </td>
      </tr>
      <tr>
       <td>
